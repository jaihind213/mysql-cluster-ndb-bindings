...
int main()
{
  ...
  const NdbDictionary::Table *myTable= myDict->getTable("dtest");
  const NdbDictionary::Column *myCol = myTable->getColumn("d");
...

  {
    ...
    int dport = 20040506; 
    int tport =123456; 
    Uint64 dt = (Uint64)20040506*1000000+123456;
    if (myOperation->setValue("d", dt) == -1) 
      APIERROR(myOperation->getNdbError());
