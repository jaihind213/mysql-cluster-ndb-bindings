 ...
 * >java com.mysql.cluster.ndbj.examples.ReadRowsUsingTableScan ${NDBJ_HOME}/ndbj_localhost.props
 * 
 * @author jdowling
 */
public class ReadRowsUsingTableScan {
	...
	public static void main(String[] args) {
		...
		ReadRowsUsingTableScan operations = null;
		try {
			operations = new ReadRowsUsingTableScan(args[0]);
	...
	public ReadRowsUsingTableScan(String configFile) throws NdbApiException
	{
		/**
