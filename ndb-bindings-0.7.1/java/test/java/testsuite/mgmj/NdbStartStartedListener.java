...
import com.mysql.cluster.mgmj.listeners.NdbStartStartedTypeListener;
...
public class NdbStartStartedListener extends NdbStartStartedTypeListener {
    ...
    public void handleEvent(NdbStartStarted event) {
        ...
        if (event != null)
            System.out.println("Node " + event.getSourceNodeId()  + " StartStarted at time: " + event.getEventTime());
    }
