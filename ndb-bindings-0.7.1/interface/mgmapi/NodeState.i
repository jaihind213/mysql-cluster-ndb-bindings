...
public:
  ...
  const char * getStartupPhase() {
    ...
    case 0:
      startPhaseStr="Startup Phase 0. "
        "Clearing the filesystem, "
        "--initial was specified as startup option.";
      break;
    case 1:
      startPhaseStr="Startup Phase 1. "
        "Establishing inter-node connections in cluster.";
      break;
    case 2:
      startPhaseStr="Startup Phase 2. "
        "The arbitrator node is elected. If this is a system restart, "
        "the cluster determines the latest restorable "
        "global checkpoint.";
      break;
    case 3:
      startPhaseStr="Startup Phase 3. "
        "This stage initializes a number of "
        "internal cluster variables.";
      break;
    case 4:
      startPhaseStr="Startup Phase 4. "
        "If initial (re)start: redo log files are created. "
        "If system restart: read schemas, LCP, redo logs up to "
        "last GCP. Node restart: Find tail of redo log.";
      break;
    case 5:
      startPhaseStr="Startup Phase 5. "
        "If initial start: creating internal system tables. "
        "If node restart or initial restart: include node in "
        "transactions, synchronise with node group and master.";
      break;
    case 6:
      startPhaseStr="Startup Phase 6. Update Internal variables.";
      break;
    case 7:
      startPhaseStr="Startup Phase 7. Update Internal variables.";
      break;
    case 8:
      startPhaseStr="Startup Phase 8. "
        "If system restart: rebuild all indexes.";
      break;
    case 9:
    ...
    case 101:
      ...
      break;
    default:
      startPhaseStr="Undefined Startup Phase";
      break;
    }
