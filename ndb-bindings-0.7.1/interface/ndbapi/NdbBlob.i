...
public:
  ...
  State getState();
  /* TODO: Implement ActiveHook callback
  ...
  voidint getValue(char* BYTE, Uint32 bytes);

#ifdef SWIGPYTHON
  %rename(setVal) setValue(const char* data, Uint32 bytes);
#endif

  voidint setValue(const char* BYTE, size_t len);
  ...
  */
  ...
  %exception;
  static int getBlobTableName(char* btname, Ndb* anNdb,
